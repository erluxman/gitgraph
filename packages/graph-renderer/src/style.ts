...
export const COLOURS = {
  green: 0x4ade80,
  red: 0xef4444,
  // Amber instead of pure orange: clearly yellower than the red so a
  // red file and a downstream-orange file don't blur into each other,
  // and clearly more saturated than the core yellow so they don't
  // either.
  orange: 0xf59e0b,
